							...
							<table class="table table-responsive">
								<thead>
									<tr>
										...
										<th class="tableHeaderTags text-center" style="vertical-align: middle;">Destination
										</th>
							...
							<table class="table table-responsive">
								...
								while ($trainTicketsRow = $trainTicketsQuery->fetch_assoc()) {
									...
									<tr>
										...
										<td class="text-center"><a
												href="tickets/trainTicket<?php echo $trainTicketsRow["bookingID"]; ?>.html"
												target="_blank"><span
													class="fa fa-download tableElementTags pullSpan"></span></a></td>
									</tr>
					...
					<?php else: ?>
						...
						<div class="col-sm-12 ticketTableContainer" id="trainTicketsWrapper">
							...
							<div class="noBooking">
								...
								Looks like you haven't booked any train with us yet. This area will list all your train
								bookings once you start booking trains.
