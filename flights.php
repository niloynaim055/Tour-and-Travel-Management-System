   							...
   							<div class="form-group">
   								 <label for="origin">Origin:<p> </p></label>
      								...
      								<select id= "origin"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin" name="origin" required>
       									<option value="Dhaka" data-subtext="DHA" data-tokens="DEL New Delhi">Dhaka</option>
        								<option value="Cox" data-subtext="COX" data-tokens="BOM Mumbai">Cox's Bazar</option>
        								<option value="kuakata" data-subtext="KUA" data-tokens="CCU Kolkata">kuakata</option>
        								<option value="Barishal" data-subtext="BAR" data-tokens="BLR Bengaluru">Barishal</option>
        								<option value="Rangamati" data-subtext="RAN" data-tokens="PNQ Pune">Rangamati</option>
        								<option value="Bandarban" data-subtext="BAN" data-tokens="MAA Chennai">Bandarban</option>
        								<option value="Khulna" data-subtext="KHU" data-tokens="GAU Guwahati">Khulna</option>
        								<option value="Sylhet" data-subtext="SYL" data-tokens="BHI Bhopal">Sylhet</option>
        								<option value="Rajshahi" data-subtext="RAJ" data-tokens="JAI Jaipur">Rajshahi</option>
        								<option value="Chittagong" data-subtext="CHI" data-tokens="AMD Ahmedabad">Chittagong</option>
      								</select>
							</div>
            			</div>
