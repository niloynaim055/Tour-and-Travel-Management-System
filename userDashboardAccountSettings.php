	...
	<div class="container-fluid">
		...
		<div class="col-sm-12 userDashboard text-center">
			...
			<div class="col-sm-7 containerBoxRight text-left">
				...
				$tourBookingsSQL = "SELECT COUNT(*) FROM `tour_booking` WHERE user_id='$userID'";
				...
				<div class="col-sm-12 settings">
					...
					<div class="col-sm-6 settingsWrapper topMargin">
						<span class="tag">No. of train bookings: </span><span class="content text">
							<?php echo $noOfTrainBookings[0]; ?>
						</span>
					</div> <!-- change echo -->
					<div class="col-sm-12 settingsWrapper">
						<span class="tag">No. of hotel bookings: </span><span class="content">
							<?php echo $noOfHotelBookings[0];
							; ?>
						</span>
					</div> <!-- change echo -->
					<div class="col-sm-12 settingsWrapper">
						<span class="tag">No. of tour bookings: </span><span class="content">
							<?php echo $noOftourBookings[0];
							; ?>
						</span>
					</div> <!-- change echo -->
					<div class="col-sm-6 settingsWrapper">
						<span class="tag">Delete account: </span>
						<input type="button" class="button" id="deleteAccount" name="deleteAccount"
							value="Delete Account">
					</div> <!-- change echo -->
					<div class="col-sm-6 settingsWrapper warning">
						Please note that delete if you delete an account, you will lose access to all the data and
						E-tickets asociated with that account. Proceed with caution.
					</div>
