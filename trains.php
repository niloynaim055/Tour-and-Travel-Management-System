   							...
   							<div class="form-group">
   								 <label for="originTrain">Origin:<p> </p></label>
      								...
      								<select id= "originTrain"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin Station" name="origin" required>
       									<option value="Dhaka" data-subtext="DHA" data-tokens="DLI New Delhi">Dhaka</option>
        								<option value="Chittagong" data-subtext="CHI" data-tokens="HWH Howrah">Chittagong</option>
       									<option value="Rajshahi" data-subtext="RAJ" data-tokens="GHY Guwahati">Rajshahi</option>
        								<option value="Sylhet" data-subtext="SYL" data-tokens="SCL Silchar">Sylhet</option>
        								<option value="Jessore" data-subtext="JES" data-tokens="DMV Dimapur">Jessore</option>
      								</select>
							</div>
            			</div>
