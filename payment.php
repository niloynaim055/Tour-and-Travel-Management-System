...
<html lang="en">
	...
	<body>
		...
		elseif($mode=="package") {
			...
			$travelersJsonObj=$_POST["travelersJsonObjHidden"];
			$contact=$_POST["contactHidden"];
	} 
		//for hotels
		...
		<div class="col-sm-12 paymentWrapper">
			...
			<div class="col-sm-6">
				...
				<form action="generatePackageReceipt.php" method="POST">
					...
					<input type="hidden" name="travelars" value="<?php echo $travelers; ?>">
					<input type="hidden" name="travelersJsonObj" value='<?php echo $travelersJsonObj; ?>'>
