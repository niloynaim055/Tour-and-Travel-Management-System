   							...
   							<div class="form-group">
   								 <label for="city">City:<p> </p></label>
      								...
      								<select id= "city"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" required>
        								...
        								<option value="Cox" data-tokens="BOM Mumbai">Cox's Bazar</option>
        								<option value="Kuakata" data-tokens="CCU Kolkata">Kuakata</option>
        								<option value="Bandarban" data-tokens="BLR Bangalore">Bandarban</option>
        								<option value="Chittagong" data-tokens="MAA Chennai">Chittagong</option>
        								<option value="Sylhet" data-tokens="PNQ Pune">Sylhet</option>
        								<option value="Rajshahi" data-tokens="KER Kerala">Rajshahi</option>
        								<option value="Sundorban" data-tokens="GAU Guwahati">Sundorban</option>
      								</select>
							</div>
            			</div>
